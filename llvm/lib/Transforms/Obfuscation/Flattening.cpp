...
// Tanner
INITIALIZE_PASS_BEGIN(Flattening, "flattening", "Call graph flattening", false,
                      false)
INITIALIZE_PASS_DEPENDENCY(LowerSwitch)
INITIALIZE_PASS_END(Flattening, "flattening", "Call graph flattening", false,
                    false)
...
bool Flattening::flatten(Function *f) {
  ...
  // Lower switch
  FunctionPass *lower =
      (FunctionPass *)getResolver()->findImplPass(&LowerSwitchID); // Tanner
  ...
  switchVar = new AllocaInst(varType, 0, "switchVar", insert);
  new StoreInst(
  ...
  load = new LoadInst(varType, switchVar, "switchVar", loopEntry);
